...
html = <<~HTML
  ...
  <body><main>
    ...
    <p>R3 occupies <code>funct7=0x00..0x50</code>. R2 fills all 32 <code>xfunct5</code> values in bank <code>0x51</code> before continuing in bank <code>0x52</code>. R1 uses bank <code>0x53</code> with <code>xfunct10=0..1</code>. The 44 <code>funct7</code> values <code>0x54..0x7f</code> remain unallocated.</p>
    <div class="formats">
