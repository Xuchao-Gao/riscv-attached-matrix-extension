...
html = <<~HTML
  ...
  <body><main>
    ...
    <p>R3 occupies <code>funct7=0x00..0x50</code> and <code>funct7=0x54..0x5c</code>. R2 uses bank <code>0x51</code> with <code>xfunct5=0..31</code> except reserved value <code>0x09</code>, then continues in bank <code>0x52</code>. R1 uses bank <code>0x53</code> with <code>xfunct10=0..3</code>. The 35 <code>funct7</code> values <code>0x5d..0x7f</code> remain unallocated.</p>
    <div class="formats">
